...
namespace SharpSid
{
    public static class OpCode
    {
        ...
        public const int NOPb_1 = 0x82;

        public const int NOPb_2 = 0xC2;

        public const int NOPb_3 = 0xE2;

        public const int NOPb_4 = 0x89;
        ...
        public const int NOPz_1 = 0x44;

        public const int NOPz_2 = 0x64;
        ...
        public const int NOPn_1 = 0x1A;

        public const int NOPn_2 = 0x3A;

        public const int NOPn_3 = 0x5A;

        public const int NOPn_4 = 0x7A;

        public const int NOPn_5 = 0xDA;

        public const int NOPn_6 = 0xFA;

        //

        public const int ANCb = 0x0B;

        public const int ANCb_1 = 0x2B;
        ...
        public const int NOPzx_1 = 0x34;

        public const int NOPzx_2 = 0x54;

        public const int NOPzx_3 = 0x74;

        public const int NOPzx_4 = 0xD4;

        public const int NOPzx_5 = 0xF4;
        ...
        public const int NOPax_1 = 0x3C;

        public const int NOPax_2 = 0x5C;

        public const int NOPax_3 = 0x7C;

        public const int NOPax_4 = 0xDC;

        public const int NOPax_5 = 0xFC;
